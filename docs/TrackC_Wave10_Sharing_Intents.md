...
Extends the Sharing/Intents/Clipboard tranche with deterministic sharing and external-intent dispatch surfaces.
...
- Capability/lowering/parser/toolchain: `tests/test_track_c_wave10_sharing_intents.py`
- Visible deterministic flow: `tests/test_track_c_wave10_visible_flow.py`
...
References: `tests/test_track_c_wave10_visible_flow.py`, `docs/capability_runtime_mapping_v1.md`, `runtime_abi_v1.md`
