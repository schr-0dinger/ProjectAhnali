...
Single-screen demo combining Wave 2 networking response routing with Wave 1 storage and URL launch helpers:
...
The failure branch handler (`probe_fail_btn`) always writes visible fallback markers:
