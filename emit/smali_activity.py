...
def emit_http_route_async_worker_smali(class_desc: str):
    ...
    lines.append("    invoke-static {v2}, Lcom/ahnali/runtime/HttpHelper;->setAsyncProgress(I)V")
    lines.append("    :ahnali_async_try_start")
    lines.append("    invoke-static {}, Lcom/ahnali/runtime/HttpHelper;->shouldCancel()I")
    lines.append("    move-result v2")
    lines.append("    if-eqz v2, :ahnali_async_check_input")
    lines.append("    const/4 v5, 0x7")
    lines.append("    invoke-static {v5}, Lcom/ahnali/runtime/HttpHelper;->setAsyncError(I)V")
    lines.append("    const/16 v2, 0x64")
    lines.append("    invoke-static {v2}, Lcom/ahnali/runtime/HttpHelper;->setAsyncProgress(I)V")
    lines.append("    goto :ahnali_async_fail_post")
    ...
    lines.append("    if-eqz v1, :ahnali_async_invalid_input")
    lines.append("    const/16 v2, 0x32")
    lines.append("    invoke-static {v2}, Lcom/ahnali/runtime/HttpHelper;->setAsyncProgress(I)V")
    lines.append(
    ...
    lines.append("    invoke-static {}, Lcom/ahnali/runtime/HttpHelper;->shouldCancel()I")
    lines.append("    move-result v3")
    lines.append("    if-eqz v3, :ahnali_async_cancel_checked")
    lines.append("    const/4 v5, 0x7")
    lines.append("    :ahnali_async_cancel_checked")
    lines.append("    const/16 v3, 0xc8")
    lines.append("    if-ne v2, v3, :ahnali_async_fail_branch")
    lines.append("    if-nez v5, :ahnali_async_fail_branch")
    lines.append("    const/4 v3, 0x0")
    lines.append("    invoke-static {v3}, Lcom/ahnali/runtime/HttpHelper;->setAsyncError(I)V")
    lines.append("    const/16 v3, 0x64")
    lines.append("    invoke-static {v3}, Lcom/ahnali/runtime/HttpHelper;->setAsyncProgress(I)V")
